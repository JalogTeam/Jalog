...
System.out.println("T: " + T);
        ...
        found = NOT_FOUND;
        while(found != TOKEN_FOUND)
        {
System.out.println("found != TOKEN_FOUND");
...
System.out.println("FAIL: " + currentItem.term_out + " " +
  subItem.term_out);
          ...
          } while((found != TOKEN_FOUND && found != CATCHALL_FOUND) ||
              state == 0);

          // (found == TOKEN_FOUND || found == CATCHALL_FOUND)
          {
...
System.out.println("state = " + state);
      ...
      } // while(state != 0 || tai rivi lopussa)
