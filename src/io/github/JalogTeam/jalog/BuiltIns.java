...
public class BuiltIns
{
  static ClassInfo[] list = {
    ...
    new ClassInfo(">", Pred__cmpr_.class, 2),
    new ClassInfo(">=", Pred__cmpr_.class, 2),
    new ClassInfo("assert", Pred_assertz.class, 1, 2),
    new ClassInfo("asserta", Pred_asserta.class, 1, 2),
    new ClassInfo("assertz", Pred_assertz.class, 1, 2),
    ...
    new ClassInfo("writedevice", Pred_writedevice.class, 1),
