// Pred_openappend.java
// openappend(String symbolic_filename, String filename) - (i,i)

package io.github.JalogTeam.jalog;

public class Pred_openappend extends Pred
{
...
if(x)throw new Error();
    if((data.subterm[0].getType() != Typenames.OPEN) &&
      ...
      FileManager.openappend(symbolic_filename, filename);
