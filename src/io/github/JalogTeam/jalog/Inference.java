...
public class Inference // extends Pred
{
  ...
  {
// Debug_times.enter(1); 
if(Debug > 0) System.err.println("*** BEGIN Inference: body=" + body);
//    if(level > 0) System.err.println("** BEGIN Inference: recursion level=" + level);
    level ++;
...
// Debug_times.leave(5); 
    ...
    level --;
//    if(level > 0) System.err.println("** END Inference: recursion level=" + level);
// Debug_times.leave(1);
// Debug_times.report();
  }
}
