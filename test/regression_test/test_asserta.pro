...
koe2 :- trap(asserta((clause :- writeln("  oho!"), writeln("  Wow!"))),
...
koe4 :- writeln(';'), fail.
koe4 :- write("koe4 b: "), 
  trap(asserta(k3data(23), dbasedom), Err, writeln("Error: ", Err)),
  writeln("Bad success"), fail.
koe4 :- write("koe4 c: "), 
  trap(asserta(data(23), mac), Err, writeln("Error: ", Err)),
  writeln("Bad success"), fail.
...
koe6 :- trap(asserta((clause :- writeln("  oho!"), writeln("  Wow!"))), Err, writeln("Error: ", Err)),
    writeln("assertoitu"), fail.
