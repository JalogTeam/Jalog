...
koe6a :- write("koe6a: "), write('|'), writeq(""), write('|') ,nl.
koe6b :- write("koe6b: "), write('|'), writeq("string"), write('|') ,nl.

koe7a :- write("koe7a: "), write('|'), writeq(A), write('|') ,nl.
koe7b :- write("koe7b: "), A = B, write('|'), writeq(A), write('|'), nl.
